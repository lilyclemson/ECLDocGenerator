...
ecldoc --iroot ~/source/GaussianProcessRegression --oroot ~/docs/GaussianProcessRegression --eclcc=" -I ~/source"  --format "html,pdf" --exclude "Internal/*.ecl,Test/*.ecl" --hideInternal
